...
export class ServicesComponent {
  ...
  get services() {
    return [
      {
        title: this.translationService.t('service1.title'),
        description: this.translationService.t('service1.desc'),
        image: 'assets/bureau.png',
        icon: '<path d="M3 3h7v7H3V3zm0 11h7v7H3v-7zm11-11h7v7h-7V3zm0 11h7v7h-7v-7z" fill="currentColor"/>'
      },
      {
        title: this.translationService.t('service2.title'),
        description: this.translationService.t('service2.desc'),
      ...
      {
        title: this.translationService.t('service3.title'),
        description: this.translationService.t('service3.desc'),
        image: 'assets/residentiel.jpeg',
      ...
      {
        title: this.translationService.t('service4.title'),
        description: this.translationService.t('service4.desc'),
        image: 'assets/fin-de-chantier.png',
